...
Randomly sample points from a square with side length 2 and check if they fall inside the unit circle. Use this simulation to estimate the value of pi. (Use at least 10,000 simulations).

2. You are playing Dungeons and Dragons. You are an Elf named Steve and you come up against a Orc named Mobrukk Pride Bruiser. You must battle. In order to defeat the Mobrukk you must do the following:
